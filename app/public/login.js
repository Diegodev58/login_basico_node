...
// Añade event listener al formulario de login
document.getElementById("login-form").addEventListener("submit", async (e) => {
  e.preventDefault(); // Evita el envío tradicional del formulario
  
  // Obtiene los valores del formulario
  const user = e.target.children.user.value; // Obtiene valor del campo 'user'
  const password = e.target.children.password.value; // Obtiene valor del campo 'password'
